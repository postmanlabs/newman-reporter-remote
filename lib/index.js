const
     ...
     *
     * @param {Array} members - All members of an
     * @param {String} [path] -
     */
     ...
     *
     * @param {Array} element - All members of an
     * @param {String} [path] -
     */
    ...
    remoteReporter = function (newman, options, cr) {
        if (!options.api) {
            console.error('newman-reporter-remote: missing required option `api`');
        ...
        var
            ...
            run = {
                ...
                agent: {
                    name: 'newman',
                    version: cr.newmanVersion,
                    platform: os.platform(),
                    id: uuid() // TODO: Get it from the users system
                }
            },
            executions = [],
            requests = {},
        ...
        newman.on('request', function (err, data) {
            ...
            requests[data.cursor.httpRequestId] = {
                ...
                response: {
                    $self: ['responses', data.respons && data.response.id]
                },
        ...
        newman.on('done', function () {
            ...
            request(Object.assign({}, options.api, {
                ...
                if (err) {
                    console.error('newman-reporter-remote:\n error: ', err);
